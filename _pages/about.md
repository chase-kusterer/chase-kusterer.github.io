...
<!--            -->
    ...
    <li class="tl-item down" style="--stem: 130px;">
      ...
      <div class="card">
        <span class="tl-pill tl-pill--pres">Speaker</span>
        <div class="tl-range">2017</div>
        <h4 class="tl-title" style="--tl-title-size:.75rem;">Global Marketing and Technology Innovation Summit</h4>
        <div class="tl-sub">Innovation Enterprise</div>
        <div class="tl-sub">Shanghai · China</div>
      </div>
    </li>
    ...
    <li class="tl-item up" style="--stem: 130px;">
      ...
      <div class="card">
        <span class="tl-pill tl-pill--pres">Speaker</span>
        <div class="tl-range">2017</div>
        <h4 class="tl-title" style="--tl-title-size:.75rem;">A Jump Start to Building Internal Analytical Capabilities</h4>
