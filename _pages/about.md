...
<style>
  ...
  .tl-title{   margin:0; font-size:var(0.80rem); line-height:1.25; font-weight:700; hyphens:auto; overflow-wrap:anywhere; }
  .tl-sub{     margin:.15rem 0 0; font-size:var(0.60rem); color:var(--tl-muted); }
